...
protected:
    ...
    const string indexDirectory = "./btsrlt";
    const string indexDirectoryNotExists = "./btsrlt_nil";
...
protected:
    const string logPath = "./log";
    const string indexDirectory = "./bfst";
    const string indexDirectoryNotExists = "./bfst_nil";
    const string indexEmptyDirectory = "./bfst_empty";
    const vector<string> column_names = {"col1", "col2", "col3"};
