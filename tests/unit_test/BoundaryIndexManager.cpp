...
protected:
    const string indexDirectory = "./btciwtt";
...
protected:
    const string indexDirectory = "./btidt";
    const string logPath = "./log";
    const vector<string> column_names = {"col1", "col2", "col3"};
...
protected:
    const string indexDirectory = "./btdrit";
    const string indexDirectoryNotExists = "./btdrit_nil";
    const string indexEmptyDirectory= "./btdrit_empty";
    const string logPath = "./log";
...
protected:
    const string logPath = "./log";
    const vector<string> column_names = {"col1", "col2", "col3"};
    const string indexDirectory = "./btcafit";
...
TEST_F(BoundaryTantivyCreateAndFreeIndexTest, nullptrParameter) {
    ...
    ASSERT_ANY_THROW(ffi_index_multi_column_docs(indexDirectory, 0, {nullptr}, {nullptr}));
...
protected:
    const string logPath = "./log";
    const string indexDirectory = "./btct";
    const string indexDirectoryNotExists = "./btct_nil";
    const vector<string> column_names = {"col1", "col2", "col3"};
