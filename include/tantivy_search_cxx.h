...
::rust::Vec<::RowIdWithScore> ffi_bm25_natural_language_search(::std::string const &index_path, ::std::string const &sentence, ::std::uint32_t topk, ::std::vector<::std::uint8_t> const &u8_aived_bitmap, bool query_with_filter, bool operator_or, ::Statistics const &statistics) noexcept;
